    ...
    return (
        <Form onSubmit={handlerSubmit} className={styles.form}>
            <FormGroup>
                ...
                <Input type="file" id="upload_image" name="upload_image" onChange={handleFileChange}/>
            </FormGroup>
            <Button outline disabled={!haveFile} className={styles.button} type="submit">Extract</Button>
        </Form>
    );
}
